    ...
    <body>
        ...
        <div class="container">
            ...
            <div id ="refdiv" class="col-md-12">
                <button class="addbutton"> View Additional Address</button>
        ...
        <div id ="refdiv2" class="col-md-12">
                <button class="addphonebutton"> View Additional Phone</button>
        ...
        <div class="row">
            ...
            <div id ="refdiv3" class="col-md-12">
                <button class="adddatebutton"> View Additional Date</button>
